...
export const TIERS = [
  {
    ...
    priceUsd: 0,
    priceLabel: '$0',
    aiBucks: usdToBucks(0.30),
    description: 'Log meals, view history, and try AI features',
    features: [
      { included: true,  text: 'Log meals manually' },
      { included: true,  text: 'Track macros and goals' },
      { included: true,  text: 'View history and analytics' },
      { included: true,  text: `${usdToBucks(0.30).toLocaleString('en-US')} AI Bucks/month` },
      { included: false, text: 'Photo meal analysis' },
      { included: false, text: 'Barcode scanning' },
      { included: false, text: 'Recipe import from photos/URLs' },
      { included: false, text: 'AI meal planner' },
    ],
  },
  {
    id: 'premium',
